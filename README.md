...
> 📧 **Subscribe to the Newsletter** Stay informed about new MCP servers and updates:
...
- **OAuth 2.1 🔐**: Indicates OAuth 2.1 authentication *without* dynamic client registration support. This means you may need to pre-register your client application with the provider, or use an API key pre generated by the provider.
...
| Atlassian | Software Development | `https://mcp.atlassian.com/v1/sse` | OAuth2.1 🔐 | [Atlassian](https://atlassian.com) |
...
| Box | Document Management | `https://mcp.box.com` | OAuth2.1 🔐| [Box](https://box.com) |
...
| Close CRM | CRM | `https://mcp.close.com/mcp` | OAuth2.1 🔐 | [Close](https://close.com/) |
...
| GitHub | Software Development | `https://api.githubcopilot.com/mcp` | OAuth2.1 🔐 | [GitHub](https://github.com) |
...
| Plaid | Payments | `https://api.dashboard.plaid.com/mcp/sse` | OAuth2.1 🔐| [Plaid](https://plaid.com) |
...
| Ryze AI (Google Ads, Meta Ads & SEO) | Advertising | `https://connector.get-ryze.ai/mcp` | OAuth2.1 | [Ryze AI](https://www.get-ryze.ai) |
...
**Instructions:** Go to Settings → Connectors → Add Custom Connector and fill in:
- **Name**: test
- **URL**: https://mcp.my-awesome-server.com/sse
...
**Instructions:** Go to MCP Servers section → Remote Servers → Edit Configuration
